...
import {createImageryLoader,localImageryURL} from '../dist/imagery.js';
...
// The packet protocol is exercised end to end in check-imagery-packs.mjs.
console.log(JSON.stringify({legacyImagery:'passed',browserIGNRequests:0,timeoutAndCancellation:'passed',invalidImages:'rejected'}));
